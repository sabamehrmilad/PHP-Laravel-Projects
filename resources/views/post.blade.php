                ...
                <div class="container" >
                    <table class="table table-bordered table-responsive" style="border-radius: 15px; background-color: white; margin-top: 20px; " >
                        ...
                        @foreach($posts as $row)
                            <tr>
                                <td>{{$row->title}}</td>
                                <td style="width: 200px; height:200px">{{$row->description}}</td>
                                <td><img class="img-thumbnail" alt="Responsive image" width="300px" height="300px"   src="images/{{$row->postimg}}" /></td>
