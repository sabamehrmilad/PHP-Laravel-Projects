        ...
        <div class="content-wrapper">
            ...
            <section class="content container-fluid">
                <!--------------------------
                  ...
                  -------------------------->
                <form name="createuser-form" id="createuser-form" method="POST" action="{{url('/user/store')}}">
                    {{csrf_field()}}
                    ...
                    <div class="form-group" >
                        ...
                        <div class="input-group">
                            ...
                            <input  type="text" name="date_picker" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" placeholder="تاریخ تولد خود را وارد کنید" data-mask>
                        </div>
                        <!-- /.input group -->
                    </div>
