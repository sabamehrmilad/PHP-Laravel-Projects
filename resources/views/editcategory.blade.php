        ...
        <div class="content-wrapper">
            ...
            <form action="{{route('categories.update', $categories ->id)}}" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group col-md-9">
                    ...
                    <input type="text" name="name" value="" class="form-control"   id="formGroupExampleInput" placeholder="{{$categories ->name}}">
                </div>

                <div class="custom-file col-md-12">
                    <input type="file" name="img" value="images/{{$categories ->img}}"   id="fileToUpload" class="custom-file-input" >
                </div>
