        ...
        <div class="content-wrapper">
            ...
            <form action="{{url('/post')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-9">
                    ...
                    <input type="text" name="title" class="form-control"  id="formGroupExampleInput" placeholder="موضوع خود را وارد کنید">
                </div>
                <div class="form-group col-md-6">
                    <label for="formGroupExampleInput2">شرح</label>
                    <textarea   type="text" name="description" class="form-control" id="formGroupExampleInput2" placeholder="شرح دهید"></textarea>
                </div>
                <div class="custom-file col-md-12">
                    <input type="file" name="postimg"  id="fileToUpload" class="custom-file-input" >
                </div>
                <select class="form-control form-control-sm col-md-3 col-auto  " style="margin-top: 10px;margin-right: 5px"  name="categoryId">
                    @foreach($categories as $row)
                    <option name="category-id" value="{{ $row->id }}"> {{$row->name}} </option>
                    @endforeach
